...
Each OPQBox2 processes 2.7 billion samples per day. OPQBox2's forward to the cloud service 500,000 PQ measurements per day. In general, we see on the order of one grid wide power quality event per day with a small number of devices.
